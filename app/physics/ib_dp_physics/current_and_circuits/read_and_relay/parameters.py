...
attempt_question_instructions_question = "You have to attempt the following question on " + topic + ". To attempt the question, you will need to use the concepts and formulas provided by the user. The question is:\n"
...
attempt_question_instructions_pointers = "Till the user mentions the concepts and formulas required to solve the question, you have to keep giving an incomplete solution. Keep the following points in mind while giving your response:\n" + \
    ...
    "3) For any missing concepts or formulas, ask the user for a clarification. The clarification should be tailored to the question given above. But ensure that you NEVER reveal the missing concepts or formulas to the user.\n" + \
    "4) If NONE of the required concepts or formulas are provided by the user, you should simply respond that you are unable to attempt the question.\n" + \
    "5) YOU ARE NOT ALLOWED TO USE ANY CONCEPT OR FORMULA THAT IS NOT EXPLICITLY MENTIONED BY THE USER."
