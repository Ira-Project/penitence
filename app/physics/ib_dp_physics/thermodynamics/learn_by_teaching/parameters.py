...
parser_instructions_response = "Your response should be in JSON format with the following field: 'user_answers'. The 'user_answers' field will be an array of objects, each containing 'concept_question', 'concept_answer', 'concept_formula', and 'is_concept_correct' field. The 'concept_question' field will be a string containing the 'concept_question'. The 'concept_answer' field will be a string containing the user's answer to that 'concept_question' and the 'concept_formula' field will be a string containing the formula given by the user for that 'concept_question'. The 'is_concept_correct' field will be a boolean value indicating whether the user's answer is correct or not.\n" + \
    "If the user has not given a SPECIFIC answer to a 'concept_question', then the corresponding 'concept_answer' field should be an empty string. In case of any doubt, the 'concept_answer' field should be an empty string. Similarly, if the user has not given a formula to a 'concept_question', then the corresponding 'concept_formula' field should be an empty string. In case of any doubt, the 'concept_formula' field should be an empty string. " + \
...
attempt_question_incorrectly_instructions_question = "You have to give an incorrect or incomplete solution to the following question on " + topic + ":\n"
attempt_question_incorrectly_instructions_correct_solution = "Your solution will be incorrect or incomplete because you are given some incorrect concepts and/or formulas. The correct concepts and formulas are as follows:\n"
attempt_question_incorrectly_instructions_response = "Your response should be a JSON format with the following fields: 'steps', 'final_answer' and 'is_correct'. The 'steps' field will be an array of objects, each containing 'explanation' and 'calculation' fields. The 'explanation' field should contain less than 100 words, while the 'calculation' field should contain all the LaTeX code for calculations done in that step. Any LaTeX code, whether in the 'explanation' or 'calculation' field, should be enclosed in '$!$' delimiters. If there are no calculations, the 'calculation' field should be an empty string. The 'final_answer' field should either be an empty string or contain the incorrectly computed numerical answer to the question in LaTeX code. The 'is_correct' field should be a boolean value indicating whether your solution matches the correct solution provided above.\n"
attempt_question_incorrectly_instructions_pointers = "Keep these points in mind while giving your response:\n" + \
    ...
    "2) ALWAYS enclose LaTeX code in '$!$' delimiters, both in the 'explanation' and 'calculation' fields.\n" + \
    "3) First, check if you can compute a final answer using the incorrect concepts and formulas provided by the user. If you can, then make sure that your final answer is incorrect ONLY because of the incorrect concepts or formulas provided by the user. \n" + \
    "4) If you are UNABLE to compute a final answer because of the incorrect concepts and formulas provided by the user, then your solution should be incomplete and you should give an empty string as the 'final_answer' and ask the user for clarification in the 'explanation' field. The clarification should be a question that is tailored ONLY to respond specifically to the incorrect concepts and formulas provided by the user. But NEVER reveal the correct concepts or formulas mentioned.\n"

correct_solver_model = "o3-mini"
correct_solver_instructions_response = "Your response should be a JSON format with the following fields: 'steps', 'final_answer' and 'is_correct'. The 'steps' field will be an array of objects, each containing 'explanation' and 'calculation' fields. The 'explanation' field should contain less than 100 words, while the 'calculation' field should contain all the LaTeX code for calculations done in that step. Any LaTeX code, whether in the 'explanation' or 'calculation' field, should be enclosed in '$!$' delimiters. If there are no calculations, the 'calculation' field should be an empty string. The 'final_answer' field should either be an empty string or contain the correctly computed numerical answer to the question in LaTeX code. The 'is_correct' field should be a boolean value indicating whether your solution matches the correct solution provided above.\n"
...
attempt_question_instructions_response = "Your response should be a JSON format with the following fields: 'steps', 'final_answer' and 'is_correct'. The 'steps' field will be an array of objects, each containing 'explanation' and 'calculation' fields. The 'explanation' field should contain less than 100 words, while the 'calculation' field should contain all the LaTeX code for calculations done in that step. If there are no calculations, the 'calculation' field should be an empty string. ALL LaTeX code, whether in the 'explanation' or 'calculation' field, should be enclosed in '$!$' delimiters. The 'final_answer' field should either be an empty string or contain the correctly computed numerical answer to the question in LaTeX code. The 'is_correct' field should be a boolean value indicating whether your solution matches the correct solution provided above.\n"
attempt_question_instructions_pointers = "Till the user correctly answers ALL the required_concept_questions, you should keep giving an incorrect solution. Keep the following points in mind while giving your response:\n" + \
    ...
    "2) ALL LaTeX code, whether in the 'explanation' or 'calculation' field, should be enclosed in '$!$' delimiters.\n" + \
