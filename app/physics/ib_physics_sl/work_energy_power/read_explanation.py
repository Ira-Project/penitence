...
def read_explanation(required_information, explanation):
    ...
    checklist_json = check_information(
        information_list, explanation, instructions_post="")
...
def find_gpe_formula(formula):
    ...
    if formula_json['formula'] == "Unknown":
        ...
        steps_response = steps_response + \
            insert_latex("Gravitational Potential Energy = " +
                         latex(gpe)) + "\n"
...
def find_ke_formula(formula):
    ...
    if formula_json['formula'] == "Unknown":
        ...
        steps_response = steps_response + \
            insert_latex("Kinetic Energy = " + latex(ke)) + "\n"
