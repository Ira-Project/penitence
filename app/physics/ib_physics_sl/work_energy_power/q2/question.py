...
question = "A {mass} dumbell is initially kept on a rack of height {initial_height}. It is then lifted to a height of {final_height}. Calculate the work done in lifting the dumbell.".format(
    mass=mass, initial_height=initial_height, final_height=final_height)
question_image = "No"
