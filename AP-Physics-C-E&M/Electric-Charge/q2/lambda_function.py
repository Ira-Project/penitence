...
answer_list = [
    "One has a postive charge and the other has a negative charge."
]
...
def lambda_handler(event, context):
    ...
    if required_concepts_dict[r_c[0][0]] == "Yes":
        ...
        if required_concepts_dict[r_c[0][1]] == "Yes":
            ...
            follow_up_answer = answer_explanation("What are the two types of charges?", learner_explanation,
        ...
        if follow_up_json["verifications"][0]['verification_answer'] == "Yes" or follow_up_json["verifications"][0]['verification_answer'] == "Unknown":
            ...
            follow_up_answer = answer_explanation("How many types of charges are there?", learner_explanation,
            ...
            if required_concepts_dict[r_c[0][1]] == "Yes":
                ...
                if required_concepts_dict[r_c[0][2]] == "Yes":
                    ...
                    if follow_up_json["verifications"][0]['verification_answer'] == "Yes":
                        follow_up_answer = answer_explanation("Which two charges attract each other?", learner_explanation,
